        ...
        <>
          ...
          <form onSubmit={handleSearchSubmit} className="relative flex items-center">
            <input 
              ...
              className="bg-surface-elevated text-sm text-on-dark placeholder-muted border border-hairline rounded-full px-4 py-1.5 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary w-48 transition-all"
            />
          </form>
