...
export default function TrackedProfileView() {
    ...
    const [displayMode, setDisplayMode] = useState('units');
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-surface-card p-8 rounded-xl border border-hairline text-center">
                    <div className="flex items-center justify-center gap-2 mb-2">
                        <p className="text-[10px] font-black text-muted uppercase tracking-widest">{translate('sharpe.title')}</p>
                        <InfoTooltip text={translate('sharpe.tooltip')} />
                    </div>
            ...
            {stats?.equityCurve?.length > 0 && (
                <section className="space-y-6">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-xl font-bold text-on-dark">Performance Charts</h3>
                    </div>
