    ...
    public String analyzeBet(String postText, List<String> localImagePaths) {
        try {
            ...
            String enhancedPrompt = systemPrompt + "\n\n" +
                ...
                "TEAM_TOTAL_GOALS, TEAM_TOTAL_GOALS_OVER_UNDER, TEAM_TOTAL_SHOTS, TOTAL_CARDS_OVER_UNDER, " +
                "DOUBLE_CHANCE, HANDICAP, ASIAN_HANDICAP, CORRECT_SCORE, BOTH_TEAMS_TO_SCORE, " +
                "PLAYER_TOTAL_SHOTS, PLAYER_SHOTS, PLAYER_SHOTS_ON_TARGET, PLAYER_FOULS, PLAYER_FOULS_COMMITTED_AGAINST, " +
                "CORNERS_HEAD_TO_HEAD, CORNER_1X2, PLAYER_PROPS, PREDICTION_MARKET, OUTRIGHT, OTHER. " +
                "Use OVER_UNDER or TOTALS_OVER_UNDER for match totals, TEAM_TOTAL_GOALS for team goals, " +
                "DOUBLE_CHANCE for 1X/X2/12, MATCH_ODDS for match winner.\n" +
                "7. For BetBuilder combos, populate builderConditions as a JSON array of objects with marketType, selection, and line " +
                "(when applicable). Use ONLY marketType values from the list above.\n";
