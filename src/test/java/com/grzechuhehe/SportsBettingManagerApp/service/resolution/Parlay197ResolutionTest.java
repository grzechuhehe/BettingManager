...
class Parlay197ResolutionTest {
    ...
    void shouldSettleNationalTeamLegsWhenScraperReturnsFinishedMatches() {
        ...
        service.processRoot(
                ...
                Set.of(200L, 201L, 204L), Set.of(200L, 201L, 204L), 0.85, 4, ResolutionTestFixtures.enrichmentBudget(), null);
    ...
    void shouldSettleExtendedParlay197Legs() {
        ...
        service.processRoot(
                197L, pool, LocalDateTime.of(2026, 6, 26, 11, 0),
                Set.of(199L, 203L), Set.of(199L, 203L), 0.85, 4, ResolutionTestFixtures.enrichmentBudget(), null);
